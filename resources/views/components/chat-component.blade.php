<div x-data="{
    ...
    <div class="fixed sm:max-w-md w-full h-full bottom-0 right-0 transition-all ease-in-out duration-2000 bg-white shadow-md rounded-md sm:m-6 overflow-hidden" :class="{'sm:h-3/5': !fullScreen, 'sm:h-4/5': fullScreen}" x-show="opened" a x-transition.opacity.scale.duration.200ms.delay.200ms x-cloak>
