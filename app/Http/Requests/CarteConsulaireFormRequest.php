...
class CarteConsulaireFormRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'father_first_name' => ['required','alpha', 'string', 'max:255'],
            'mother_first_name' => ['required','alpha', 'string', 'max:255'],
            'father_last_name' => ['required', 'alpha', 'string', 'max:255'],
            'mother_last_name' => ['required', 'alpha', 'string', 'max:255'],
