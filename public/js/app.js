...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (function () {
  return {
    ...
    prevMonth: function prevMonth() {
      var month = this.activeMonth - 1;
      var year = month === 0 ? this.activeYear - 1 : this.activeYear;
    ...
    nextMonth: function nextMonth() {
      ...
      var year = month + 1 > 12 ? this.activeYear + 1 : this.activeYear;
      month = month % 12 + 1;
      this.activeMonth = month;
      this.activeYear = year;
      this.loadDaysForMonth();
    },
    loadDaysForMonth: function loadDaysForMonth() {
      var firstDayOfCalendar = new Date(this.activeYear, this.activeMonth - 1, 1);
      var lastDayOfCalendar = new Date(this.activeYear, this.activeMonth, 0);
      this.calendarDays = this.extractDaysBetweenDates(firstDayOfCalendar, lastDayOfCalendar);
    },
    extractDaysBetweenDates: function extractDaysBetweenDates(firstDate, lastDate) {
      var dates = [];
    ...
    isSelected: function isSelected(date) {
      return this.selectedDate.getMonth() === date.getMonth() && this.selectedDate.getFullYear() === date.getFullYear() && this.selectedDate.getDate() === date.getDate();
    }
  };
});
...
/***/ "./resources/js/components/carte-consulaire-document-form.js":
/*!*******************************************************************!*\
  !*** ./resources/js/components/carte-consulaire-document-form.js ***!
  \*******************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
        ...
        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.next = 2;
                return axios__WEBPACK_IMPORTED_MODULE_1___default().get("/api/documents/".concat(documentId));
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                for (_i = 0, _Object$entries = Object.entries(_this2.fields); _i < _Object$entries.length; _i++) {
                ...
                _context2.prev = 2;
                _context2.next = 5;
                return axios__WEBPACK_IMPORTED_MODULE_1___default().post("/api/documents/".concat(documentId, "/demands"), formData, {
                  headers: {
...
/***/ "./resources/js/components/meeting-create.js":
/*!***************************************************!*\
  !*** ./resources/js/components/meeting-create.js ***!
  \***************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
